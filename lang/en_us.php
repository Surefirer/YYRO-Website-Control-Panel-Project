...
return array(	
	...
	'GenderLabel'             => '性别',
	'LoginCountLabel'         => '登陆次数',
	'LastLoginDateLabel'      => '上一次登陆日期',
	'LastUsedIpLabel'         => '上一次登陆IP',
	'AccountStateNormal'      => '正常',
	'AccountStatePending'     => 'Pending',
	'AccountStatePermBanned'  => '永久停封',
	'AccountStateTempBanLbl'  => '暂时冻结',
    ...
    'WoeHoursLabel'            => '攻城战(WoE)时间',
    'CastlesLabel'            => '城堡',
    'WhosOnlineLabel'            => "谁在线",
    'MapStaticsLabel'            => '地图信息',
    'RankingInfoLabel'            => '排行榜',
    'VendingInfoLabel'            => '实时挂店信息',
    'BuyingstoreInfoLabel'        => '实时收购店信息',
    'ItemDatabaseLabel'            => '物品资料库',
    'MobDatabaseLabel'            => '魔物资料库',
    'JoinUsInFacebookLabel'            => 'Join us on Facebook!',
    'RateUsOnRMSLabel'            => 'Rate us on RMS!',
	
	// Module: account
	// - account/changemail
	'EmailChangeTitle'        => '修改 E-mail',
	...
	'EmailChangeHeading'      => '修改 E-mail',
	'EmailChangeInfo'         => '如果您想更改在您的帐户下注册的电子邮件地址，可以填写以下表格。',
	...
	'EmailChangeLabel'        => '新 E-mail',
	'EmailChangeInputNote'    => '必须是一个有效的E-mail地址!',
	'EmailChangeButton'       => '修改 E-mail',
	// - account/changepass
	...
	'PasswordChangeHeading'   => '修改您的密码',
	'PasswordChangeInfo'      => '请输入当前密码, 然后输入新的密码和确认新的密码。',
	'CurrentPasswordLabel'    => '旧密码',
	'NewPasswordLabel'        => '新密码',
	'NewPasswordConfirmLabel' => '重新输入新密码',
	'PasswordChangeNote'      => '请确保您输入的内容正确。',
	'PasswordChangeNote2'     => '更换密码成功后, 您的账号将自动退出.',
	...
	'AccountCreated'          => '恭喜, 您注册账号成功，您已自动登陆。',
	'AccountCreateHeading'    => '账号注册',
	...
	'AccountViewCharSubHead'  => '角色',
	'AccountViewSlotLabel'    => '位置',
	...
	'AccountViewStorage'      => '%s 仓库内道具',
	'AccountViewStorageCount' => '%s 仓库内总共有 %s 个道具.',
	...
	// -history/emailchange
	'HistoryEmailTitle'       => 'E-Mail 修改',
	'HistoryEmailHeading'     => 'E-Mail 修改',
	...
	'HistoryNoEmailChanges'   => '没有修改E-Mail的纪录.',
	// - history/gamelogin
	...
	// - history/index
	'HistoryIndexTitle'       => '账号历史纪录',
	'HistoryIndexHeading'     => '账号历史纪录',
	'HistoryIndexInfo'        => '在这里，您可以查看账号过去的纪录',
	'HistoryIndexInfo2'       => '请从上面菜单中选择一个您要查看的纪录',
	// - history/passchange
	...
	'ServerInfoText'          => "在这里，您将找到各种服务器信息。",
	'ServerInfoSubHeading'    => '%s 服务器数据',
	'ServerInfoSubHeading2'   => '%s 服务器职业数据',
	'ServerInfoAccountLabel'  => '账号',
	'ServerInfoCharLabel'     => '角色',
	'ServerInfoGuildLabel'    => '工会',
	'ServerInfoPartyLabel'    => '组队',
	'ServerInfoZenyLabel'     => 'Zeny',
	// - server/status
	'ServerStatusTitle'       => 'Current Server Status',
	'ServerStatusHeading'     => '服务器状态',
	'ServerStatusInfo'        => "了解服务器的联机和脱机状态可以有效的帮您了解到服务器的现状，并帮你解决问题. 列如, 如果服务器是脱机状态，那么说明服务器在维护更新.",
	'ServerStatusServerLabel' => '服务器',
	'ServerStatusLoginLabel'  => '登陆 服务器',
	'ServerStatusCharLabel'   => '角色 服务器',
	'ServerStatusMapLabel'    => '地图 服务器',
	'ServerStatusOnlineLabel' => '在线人数',
	'ServerStatusPeakLabel'   => '最高在线人数',
	...
	'WoeTitle'                => 'WoE Hours',
	'WoeHeading'              => '攻城战 时间',
	'WoeInfo'                 => "下面是 %s 的攻城战时间.  这些时间可能会因为客观原因而改变, 若改变会提前通知.",
	'WoeServerTimeInfo'       => '服务器当前时间是:',
	'WoeServerLabel'          => '服务器',
	'WoeTimesLabel'           => '攻城战时间',
